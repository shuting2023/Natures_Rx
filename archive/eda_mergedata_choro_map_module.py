...
def loading_and_cleaning(gpkg_path):
    ...
    """
    if os.path.exists("geojson_files/cleaned_geopackage.geojson"):
        print("Loading existing cleaned file...")
        df = gpd.read_file("geojson_files/cleaned_geopackage.geojson")
    else:
        ...
        df.to_file("geojson_files/geopackage.geojson", driver="GeoJSON")
...
def df_to_geojson(df, filename="geojson_files/Greenspace_US.geojson"):
    """
